...
<div id="HEADER">
	...
	<ul>
		...
		<li><a href="viewpref.php">View Balance</a></li>
		
			<li><a href="chk.php">Make Transaction</a></li>
...
<form id="e2" name="form1" method="post" action="passChange.php">
			<input name="cus" type="submit" id="cus" value="Change Password">
</form>
</body></html>
