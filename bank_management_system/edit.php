...
<td><font size=4><div align="left"class="style1"><span class="style25">1.Select Hostel:&nbsp;</span></font>></div></td>
 &nbsp;&nbsp;&nbsp;
    <td><div align="left"class="style1"><select name="Hostel" id="Hostel" style="width:140px">
          		    <option value="t">M.S. Swaminathan</option>
					<option value="m">Homi Baba</option>
					<option value="T">Sarabhai</option>
					<option value="P">D.B.A.</option>
...
<input type="checkbox" name="pref" value="by_branch" size="3" />By Branch</div>
 &nbsp;&nbsp;&nbsp;<br />
<pre>					</pre>  <td><font size=4><div align="left"class="style1">Select By student name:<a href="search_roommate.html">Click here</a></div></font>	
<pre>
